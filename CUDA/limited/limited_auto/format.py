...
with open('output_iterative_pull_postponed_ci.txt') as f1:
	lines1 = f1.readlines()


with open('output_iterative_push_incremental_ci.txt') as f2:
        lines2 = f2.readlines()


with open('output_iterative_push_postponed_ci.txt') as f3:
        lines3 = f3.readlines()

with open('output_noniterative_push_incremental_ci.txt') as f4:
        lines4 = f4.readlines()
